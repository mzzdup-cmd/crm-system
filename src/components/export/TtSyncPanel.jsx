      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
        <div>
          ...
          <p className="text-neutral-400 text-sm mt-2 max-w-2xl">
            В ТТ уходят только полностью заполненные
            оплаты (есть VK). Позже дозаполненный VK и
            правки уже выгруженных строк обновляются
            точечно. Автозапуск:{" "}
            {SYNC_SLOTS.join(", ")} МСК, плюс ручной
            запуск.
          </p>
        </div>
