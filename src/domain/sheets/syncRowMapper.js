/**
 * Maps payment + client → 17-column Google Sheets row.
 * Single source of truth for sync format (frontend preview / docs).
 */

import { getStartDate } from "../client/clientDates";
...
export function mapPaymentToSyncRow({
  payment,
  client = {},
  cycle = 1,
}) {
...
export function getSyncRowMetadata({ payment, client, cycle }) {
  return {
